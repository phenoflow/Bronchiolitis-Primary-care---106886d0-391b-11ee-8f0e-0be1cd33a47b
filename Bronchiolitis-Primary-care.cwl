...
steps:
  ...
  bronchiolitis-primary-care-organism---primary:
    run: bronchiolitis-primary-care-organism---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  viral-bronchiolitis-primary-care---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: bronchiolitis-primary-care-organism---primary/output
  ...
  bronchiolitis-primary-care-obliteran---primary:
    run: bronchiolitis-primary-care-obliteran---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  bronchiolitis-primary-care-pneumonitis---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: bronchiolitis-primary-care-obliteran---primary/output
